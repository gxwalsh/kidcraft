...
var engine = require('../voxel-engine-master')
...
var queryData = url.parse(window.location.href, true).query;
var mySkin //= 'ironman.png'

var myName = queryData.name

if (queryData.skin) {
mySkin = queryData.skin
} else {
mySkin = 'player.png'
}
...
Client.prototype.updatePlayerPosition = function(id, update) {
  ...
  if (!player) {
    var playerSkin = skin(this.game.THREE, '/textures/'+mySkin, {
...
function userKey(name,id){
  var xhttp = new XMLHttpRequest({mozSystem: true});  
  var url = "http://kidsteamonline.com/insertuser.php?key=" + id  + "&name=" + name
